...
public class EmailController {
	...
	public Map<String, String> postEmailandResetPassword(@RequestBody String emailAddress) {
		...
		if (flag) {
			...
			emailService.sendSimpleMessage(emailAddress, "Password reset for BvalonAccess",
					"We received your request for assistance resetting your password" + ", your temp password is "
